...
import {GetWishlistSubmit, RemoveWishItemSubmit} from '../../store/actions/wishlist.actions';
...
export class WishlistPageComponent implements OnInit {
  ...
  addToCart(item: CartItem): void {
    ...
    this.store.dispatch(new LikeProductSubmit({item: item.product, isLiked: false}));
