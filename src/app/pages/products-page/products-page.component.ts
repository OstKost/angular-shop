...
import {GetProductsSubmit, LikeProductSubmit} from '../../store/actions/products.actions';
import {AddWishItemSubmit, RemoveWishItemSubmit} from '../../store/actions/wishlist.actions';
...
export class ProductsPageComponent implements OnInit {
  ...
  likeProduct(product: Product): void {
    ...
    this.store.dispatch(new LikeProductSubmit({item: product, isLiked: !product.isLiked}));
  }
}
